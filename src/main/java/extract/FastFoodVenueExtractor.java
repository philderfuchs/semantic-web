...
public class FastFoodVenueExtractor {
	...
	public void extract(Set countrySet) throws ClientProtocolException, IOException {
		...
		while (it.hasNext()) {
			...
			System.out.println(new OverpassApiService().getIdOfCountry(country));
		}
...
//		 "http://api.openstreetmap.fr/oapi/interpreter?data=%5Bout%3Ajson%5D%5Btimeout%3A25%5D%3Barea%28"
//		 + id +
...
//		 FileUtils.writeStringToFile(new File("json/fastFoodVenues.json"),
//		 gson.toJson(fastFoodVenues, typeOfSrc));
